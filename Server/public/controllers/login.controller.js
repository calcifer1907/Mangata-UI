...
var SQL_FIND_USER = "SELECT us.ID,us.EMAIL,us.PASSWORD,CONCAT(us.FIRST_NAME,\" \",us.LAST_NAME) AS USER_NAME,rl.DESCRIPTION,us.ROLE_ID\n  FROM Users us INNER JOIN roles rl ON rl.ID = us.ROLE_ID;";
var getAllUser = exports.getAllUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(request, response) {
    var _request$body, email, password, _yield$pool$query, _yield$pool$query2, row, findUser, _yield$pool$query3, _yield$pool$query4, menuRoles, isPassword, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          _context.next = 12;
          return _Connection.pool.query("SELECT TITLE,PATH FROM menu_roles WHERE ROLE_ID=?", [findUser.ROLE_ID]);
        case 12:
          _yield$pool$query3 = _context.sent;
          _yield$pool$query4 = _slicedToArray(_yield$pool$query3, 1);
          menuRoles = _yield$pool$query4[0];
          isPassword = (0, _auth.comparePassword)(password, findUser.PASSWORD);
          if (isPassword) {
            _context.next = 18;
            break;
          }
        ...
        case 18:
          token = (0, _auth.createToken)(findUser.ID, findUser.USER_NAME);
          response.json({
            TOKEN: token,
            USER_INFO: {
