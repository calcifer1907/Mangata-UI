...
ALTER TABLE reservations ADD PRIMARY KEY (CODE_RESERVATION);  
  CREATE INDEX INDEX_DATE ON reservations(CODE_RESERVATION);
  CREATE INDEX INDEX_ID_EMPLOYEE ON reservations(ID_EMPLOYEE) USING BTREE,
